...
func New() *Compiler {
	...
	for i, bi := range obj.Builtins {
		symtable.DefineBuiltin(i, bi.Name)
	}
	return &Compiler{
		constants:   []object.Object{},
...
func (c *Compiler) addInstruction(ins []byte) int {
	...
	posNewInstruction := len(currentIns)
	c.scopes[c.scopeIndex].instructions = append(currentIns, ins...)
...
func (c *Compiler) removeLastPop() {
	...
	c.scopes[c.scopeIndex].instructions = curIns[:pos]
